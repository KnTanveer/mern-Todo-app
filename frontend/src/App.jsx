...
function App() {
  ...
  const addTodo = async (e) => {
    ...
    try {
      ...
      console.log("Error adding todo:", error.response?.data);
    }
  };
                ...
                <div key={todo._id} >
                  {editingTodo === todo._id ? (
                    <div className='flex items-center gap-x-3'>
                      <input
                        className='flex-1 p-3 border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-blue-200 text-gray-700 shadow-inner'
                        value={editedText}
                      ...
                      <div className='flex items-center justify-between'>
                        <div className='flex items-center gap-x-4 overflow-hidden'>
                          ...
                          onClick={() => toggleTodo(todo._id)}
                            className={`h-6 w-6 border rounded-full flex shrink-0 items-center justify-center ${todo.completed
